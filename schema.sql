...
insert into Product values('prod15','Harry Potter and the Philosopher"s Stone','Bloomsbury',10,367,'ctg3');
insert into Product values('prod16','Emotional Intelligence by Daniel Goleman','Bloomsbury',10,499,'ctg3');
insert into Product values('prod17','To Skies and Waters','Rupa',10,419,'ctg3');
